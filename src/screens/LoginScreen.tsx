...
export default function LoginScreen({ navigation }: any) {
  ...
  const handleLogin = async () => {
    ...
    setLoading(true);
    try {
      const response = await authAPI.loginCitizen(nid.trim(), citizenshipNo.trim());

      if (response.success) {
        // Store in global state + AsyncStorage
        ...
        // Navigation handled by App.tsx (isLoggedIn state change)
      } else {
          ...
          <View style={styles.formCard}>
            ...
            <View style={styles.fieldGroup}>
              ...
              <View style={styles.fieldRow}>
                ...
                <TouchableOpacity style={styles.scanBtn} onPress={() => {
                  // Navigate to camera/OCR screen
                  Toast.show({ type: 'info', text1: 'Camera', text2: 'Scan your NID card' });
                }}>
            ...
            <View style={styles.fieldGroup}>
              ...
              <View style={styles.fieldRow}>
                ...
                />
                <TouchableOpacity style={styles.scanBtn} onPress={() => {
                  Toast.show({ type: 'info', text1: 'Camera', text2: 'Scan your citizenship card' });
                }}>
